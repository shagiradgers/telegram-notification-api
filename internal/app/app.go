...
func New(log *slog.Logger, dao dao.DAO, clients clients.Clients, host string, port int) *App {
	...
	desc.RegisterTelegramNotificationServiceServer(gRPCServer, server.NewServer(dao, clients))
